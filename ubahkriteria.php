...
//ambil data \
$s=mysqli_query($connect,"select * from kriteria where id_kriteria='$_GET[id]'");
...
<?php
if(isset($_POST['ubah'])){
	$s=mysqli_query($connect,"update kriteria set nama_kriteria='$_POST[nama_kriteria]', bobot='$_POST[bobot]', poin1='$_POST[poin1]',poin2='$_POST[poin2]', poin3='$_POST[poin3]', poin4='$_POST[poin4]', poin5='$_POST[poin5]', sifat='$_POST[sifat]' where id_kriteria='$_POST[id_kriteria]'");
