...
$s=mysqli_query($connect,"select * from alternatif where id_alternatif='$_GET[id]'");
...
<?php
if(isset($_POST['ubah'])){
	$s=mysqli_query($connect,"update alternatif set nm_alternatif='$_POST[nama_alternatif]' where id_alternatif='$_POST[id_alternatif]'");
